...
public class RequestPrescriptionRefill {
	...
	By selectMed1 = By.xpath("//textarea[@auto-grow='false']");
	...
	By sentSuccessfully = By.xpath("//h3[.='Sent Successfully!']");

	By goToHomePage = By.xpath("(//button[.='Go To Home Page'])");
	...
	public void selectMed1() {
		WebElement comment = driver.findElement(selectMed1);
		           comment.click();
		           comment.sendKeys("Test Alternate Pharmacy / Medication Comment");
	}
